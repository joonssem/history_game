...
| ID | 유물명 | 시대 | 신호 |
|---|---|---|---|
| `art_1` | 연천 전곡리 주먹도끼 | 구석기 시대 | 표현 검토: 최초, 위대한 |
| `art_3` | 고창 탁자식 고인돌 | 청동기 시대 | 표현 검토: 강력한 |
| `art_4` | 비파형 동검 | 고조선 | 표현 검토: 증명, 강력한 |
| `art_15` | 5·10 총선거 투표함 | 현대 | 표현 검토: 최초 |
| `art_16` | 대한민국 제헌 헌법 원본 | 현대 | 표현 검토: 최초 |
| `art_18` | 조선말 큰사전 필사본 원고와 한글 맞춤법 통일안 | 일제 강점기 | 표현 검토: 목숨을 걸고 |
