...
const ALLOWLIST = [
  ...
  // { re: /6·25 전쟁 때문에 많은 사람이 삶의 터전을 잃었습니다/, reason: '교과서 표준 서술, 2026-09-21 대조실 확인' }  // 2026-09-21 기획 세션 검토: 아래 셋은 교과서 수준의 인과이고 원문 범위를 넘지 않는다.
  { re: /전쟁과 분단 때문에 서로 만나지 못하게 된 가족/, reason: '이산가족 정의문. 인과가 정의 자체다(2026-09-21 기획 세션)' },
  { re: /강한 감시와 탄압 때문에 여러 형태의 민족 운동이 비밀리에/, reason: '1910년대 무단 통치와 비밀 결사의 관계는 교과서 표준 서술(2026-09-21 기획 세션)' },
  { re: /강한 탄압 때문에 공개 활동이 어려웠고/, reason: '위와 같은 근거(2026-09-21 기획 세션)' },
];
