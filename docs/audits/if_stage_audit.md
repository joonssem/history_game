...
- 보완 검토 신호: 92개 (2026-09-07 재실행 결과 90개 → 아래 실행 결과 반영 후 83개. 표는 최초 감사 시점 스냅숏이며 갱신하지 않음 — 최신 수치는 `python scripts/10_audit_if_stages.py`로 재실행해 확인)
...
| `regular_goryeo_society.json` | 3-1 | ❌ 자료 해석 (실패) | 167 | 자료 | 자료·비교 단서 2개 미만 |
...
| `regular_goryeo_war.json` | 4-1 | ↩️ 근거 보완: 과정 비교 | 50 | 자료 | 근거 설명 120자 미만, 자료·비교 단서 2개 미만 |
| `regular_gwangbok.json` | 2-1 | ❌ 자료 해석 (실패) | 179 | 자료 | 자료·비교 단서 2개 미만 |
...
| `regular_joseon_folk.json` | 3-1 | ❌ 자료 해석 (풍자와 해학의 상실) | 87 | 자료 | 근거 설명 120자 미만, 자료·비교 단서 2개 미만 |
| `regular_joseon_folk.json` | 4-1 | ↩️ 근거 보완: 자료 비교 | 48 | 자료 | 근거 설명 120자 미만, 자료·비교 단서 2개 미만 |
| `regular_joseon_founding.json` | 1-1 | ❌ 자료 해석 (실패) | 175 | 자료 | 자료·비교 단서 2개 미만 |
| `regular_joseon_founding.json` | 2-1 | ❌ 자료 해석 (실패) | 166 | 자료 | 자료·비교 단서 2개 미만 |
...
| `regular_modern_open.json` | 4-1 | ↩️ 근거 보완: 자료 비교 | 38 | 자료 | 근거 설명 120자 미만, 자료·비교 단서 2개 미만 |
...
| `regular_neolithic.json` | 2-1 | ❌ 자료 해석 (실패) | 157 | 자료 | 자료·비교 단서 2개 미만 |
| `regular_neolithic.json` | 3-1 | ❌ 자료 해석 (실패) | 164 | 자료 | 자료·비교 단서 2개 미만 |
...
| `regular_post_war.json` | 3-1 | ❌ 자료 해석 (영구 분열과 전쟁) | 81 | 자료 | 근거 설명 120자 미만, 자료·비교 단서 2개 미만 |
| `regular_post_war.json` | 4-1 | ↩️ 근거 보완: 자료 비교 | 38 | 자료 | 근거 설명 120자 미만, 자료·비교 단서 2개 미만 |
...
| `regular_sejong.json` | 4-1 | ↩️ 근거 보완: 자료 비교 | 48 | 자료 | 근거 설명 120자 미만, 자료·비교 단서 2개 미만 |
