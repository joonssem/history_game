...
- **대조**: 한국어 위키백과 「벽란도」(2026-09-14 확인, `https://ko.wikipedia.org/wiki/벽란도`) — "고려 초·중기, 특히 의종 시대(12세기)에 번성했고", "강화 천도 시기(1232~, 몽골 침입 중)에는 제 기능을 할 수 없었으며, 개경 환도(1270) 후 일부 회복되었다"고 명시. 즉 벽란도의 전성기는 몽골 침입 **이전**이고, 몽골 침입 자체가 벽란도 기능을 정지시킨 원인이다 — 기존 순서와 정반대다.
